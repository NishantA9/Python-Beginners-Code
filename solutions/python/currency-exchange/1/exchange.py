...
def exchange_money(budget, exchange_rate):
    ...
    Returns: float: The exchanged value of the foreign currency you can receive.
    Examples:
...
def get_change(budget, exchanging_value):
    ...
    Returns: float: The amount left of your starting currency after the exchange
    Examples:
...
def get_value_of_bills(denomination, number_of_bills):
    ...
    Returns:int: Calculated value of the units (bills).
    Examples:
...
def get_number_of_bills(amount, denomination):
    ...
    Parameters:
        ...
        denomination (int): The value of a single unit (bill).
    Returns: int: The number of units (bills) that can be obtained from the amount.
    Examples:
...
def get_leftover_of_bills(amount, denomination):
    ...
    Parameters:
        amount (float): The total starting value.
        denomination (int): The value of a single unit (bill).
    Returns: float: The amount that is "leftover", given the current denomination.
    Examples:
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    Parameters:
        ...
        denomination (int) The value of a single unit (bill).
    Returns: int: The maximum value you can get in the new currency.
    Examples:
        >>> exchangeable_value(127.25, 1.20, 10, 20)
        80
        >>> exchangeable_value(127.25, 1.20, 10, 5)
        95
    Note: The currency denomination is a whole number and cannot be sub-divided.
    ...
    exchanged_value = budget / actual_rate
